...
launch: windows: main.cmd (if you have some wierd characters, try main_utf-8.cmd)
        Mac OS/ubuntu: main.sh (if you have some wierd characters, try main_utf-8.cmd)
